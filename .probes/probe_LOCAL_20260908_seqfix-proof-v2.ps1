...
<#
  PROBE LOCAL / seqfix-proof-v2   -   BEHAVIOURAL proof of the step-7 fix. THIS ONE WRITES,
...
$outf  = Join-Path $OutDir ("LOCAL_{0}_seqfix-proof-v2.txt" -f $stamp)
...
Say "===== END-OF-RUN MARKER: SEQFIX-PROOF-V2-COMPLETE ====="
