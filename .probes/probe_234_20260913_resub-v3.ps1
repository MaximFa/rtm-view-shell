...
<#
  PROBE 234 / resub-v3   BOX B of two. ONE run closing BOTH analyses - shell (PR234-SHELL-RESUB-01) and backend
...
$outf  = Join-Path $OutDir ('234_' + $stamp + '_resub-v3.txt')
...
if ("$($mk['changed'])" -eq '1') {
    ...
    Say '  RESTORE IS ARMED: every stop from here on returns the flag to false.'
} else {
