...
$src = "D:\Claude\Projects\RTM View Shell\.probes\probe_234_20260906_wipe-step4.ps1"
...
$hashOk = ($sha -eq "92D5CF34442EC5D30EB30E86FDA45B5C0BEFFA3B5870BFF755FF9A24A12EDB51")
Write-Host ""
Write-Host "===== BYTES ====="
Write-Host ("  bytes  : {0}   (expect 14862)" -f $b.Length)
