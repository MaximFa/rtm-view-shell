...
<#
  PROBE LOCAL / seqfix-proof-v4   -   BEHAVIOURAL proof of the step-7 fix. THIS ONE WRITES,
...
$outf  = Join-Path $OutDir ("LOCAL_{0}_seqfix-proof-v4.txt" -f $stamp)
...
Say '  note: v2 died here on a literal backslash injected by PowerShell escaping; the SQL is now a here-string'
$sqlAfter = @'
...
Say "===== END-OF-RUN MARKER: SEQFIX-PROOF-V4-COMPLETE ====="
