<#
  PROBE  probe_234_20260919_install-934a1c5.ps1
  BASED  ON probe_234_20260919_deploy0ae2102-step2-install-v2.ps1 - the run that installed 0ae2102 on
         18.09. Shape kept; the pins, the rollback FLOOR gate, the config-preservation numbers, the
         legacy-RTM reading and the satellite acceptance are new.
  UNIT   PR234-DEPLOY-LIGHT01/L10N step 4 - install the Shell package built from 934a1c5.
  WHAT   Four product files change: two grid widgets and two .resx. No installer change, no migrations,
         no db layer - the package carries Shell only, and the updater WARNs and leaves RTM alone.
...
param(
  [string]$PackagePath = 'C:\RTMView-Ops\incoming\19092026.1236_Shell.zip'
)

$ErrorActionPreference = 'Continue'
$PinnedZipSha  = 'C3DEAEFF8A2158B3AA7FA457B3401F678F746071AA8C3A8E5382EDC575087BB0'
$PinnedWebDll  = '639D048A7EC65C31555EB1F414FF899A1719AC9DC43DEC932DD02E9F9D75A157'
$PinnedDataSys = '24F0BFACE0A0F7D076DF7CFB2CF98933B8FC7F178166FD680567440FF04DDE43'
$PinnedCommit  = '934a1c5'
# the floor we fall back to: the package this machine runs today, and the proof it is physically here
$RollbackZip    = 'C:\RTMView-Ops\incoming\18092026.2225.zip'
$RollbackZipSha = '01188805B05F3C98C4854B8F89870D9C2421CD746881ECEF80F24C3F27A7CC9A'
$RollbackWebDll = '4848C42915EA9B3B7D4933E23E5D5C8231A57B0E06A11D012C2AB4F505BBFD8E'
# what the acceptance stands on, measured on this machine at 12:20 and in the package at 12:37
$SatelliteExpect = @{
  'he-IL' = 73728
  'ru-RU' = 83968
  'en-US' = 67584
...
$ReportPath = Join-Path $OutputDir ("234_{0}_install-934a1c5.txt" -f $RunStamp)
...
Say "  GATE GREEN - the bytes on this server are the bytes built from 934a1c5"
...
Say "===== END-OF-RUN MARKER: INSTALL-934A1C5-COMPLETE ====="
Finish $stepOk
