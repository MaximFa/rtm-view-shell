<#
  PROBE  probe_234_20260919_acceptance-d702e2d.ps1
  BASED  ON probe_234_20260919_acceptance-d702e2d.ps1 - this morning's acceptance, same shape.
  UNIT   acceptance of the second Shell package (d702e2d, filter popup fit).
...
$ReportPath = Join-Path $OutputDir ("234_{0}_acceptance-d702e2d.txt" -f $RunStamp)
$ReportLines = New-Object System.Collections.ArrayList
$ExpectedCommit = 'd702e2d'
$ExpectedWebDll = '2D342BE2E2A6BBCF7BE0DA0CA1D65237122AC5D3DC61858CABBBC5EBF395D531'
...
Say ("ACCEPTANCE OF d702e2d  " + $RunStartedAt.ToString('yyyy-MM-dd HH:mm:ss') + " (machine local clock)  host=" + $env:COMPUTERNAME)
...
'@
    ...
    $queryErr = Join-Path $OutputDir ("234_{0}_acceptance-d702e2d.err.txt" -f $RunStamp)
...
Say "END-OF-RUN MARKER: ACCEPTANCE-D702E2D-COMPLETE"
