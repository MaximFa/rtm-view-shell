#!/usr/bin/env python3
"""Add 3-tab layout to DayTrend local view settings modal (clean version)."""
import os
...
def main():
    ...
    old_modal = '''<div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                        <!-- BU selector -->
                        <div class="mb-3">
    ...
    new_modal = '''<div class="modal-body p-0">
