...
3. **Самоограничение (их предложение, принято симметрично) — РЕДАКЦИЯ ИСПРАВЛЕНА 2026-09-19.**
   ⚠ Прежняя редакция: «пока не благословит СВОЙ оператор». Она строилась на допущении, что
   операторов двое. **[со слов оператора: 2026-09-19] оператор у обеих колоний ОДИН — Max.**
   Допущения не проверил ни один из двух кураторов: я взял чужую формулировку охотно, потому что
   она выглядела ограничением в МОЮ сторону, и не задал ей вопроса, который задал бы любому числу.
   **Урок шире случая: ограничение, выгодно звучащее, проверяется строже, а не мягче.**
   Действующая редакция: **норма не вводится в колонии, пока ЭТА колония не заслужила её
   собственным замером** — благословение общее, практика у каждой своя.
   Следствие, которое тоже надо знать: раз оператор общий, предметы колонии через канал ходить
   МОГУТ, но только по его прямому слову. По умолчанию канал — про нормы и опыт.
