...
> (блоб `070f34eeaaee23cbb265dcc6bd122e69633becc4` — в ветке и на диске, пере-снят 2026-09-20T10:22:04Z).
> ⛔ ПОПРАВКА ПИНА, внесена 2026-09-20T10:22:04Z по СТОПу `backend-0919`: здесь стоял `3691a233…` — блоб
> РЕДАКЦИИ ДО правки shell'ом заголовка §2б («22» -> «19»). Подпись была снята до того, как файл
> дописали, и не пере-снята. Содержание переводов это не затронуло (19 имён и английский текст
> сошлись дословно), но **пин — утверждение о конкретном теле, и устаревший пин ложен, даже
> когда предмет цел**. Старое число оставлено в этой строке намеренно: исправленный молча пин
> неотличим от измеренного.
