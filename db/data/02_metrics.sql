...
QueueNumWrapUpAgents	QM - Number of Wrap Up Agents in Queue Skill	Interactions Summary	UsersInStatusCount	Wrap Up	\N	\N	number	Data
QueueNumIcomingOnlineInteractions	QM - Number of Incoming Chats and Emails including Waiting	Interactions Summary	InteractionsCount	(CallType=="External")  && Direction == "Incoming" && (InteractionType=="Chat" || InteractionType=="email")	\N	\N	number	Data
QueueLoginDataNumTrainingUsers	Agent Group - Number of Agents in Training State Group	UsersSummary	UsersInStatusGroupCount	TRAINING			number	Data
...
MonSumAgentsMakeCalls	Agent Group - Number of Outbound Calls	UsersInteraction	InteractionsCount	CallType=="External" && Direction=="Outgoing"	\N	\N	number	Data
MonAgentTalkDurationPct	Agent - Cumulative Talk Duration Percent	User	TotalStatusGroupPercent	ONPHONE	\N	\N	number	Agent
QueueLoginDataNumLoggedUsers	Agent Group - Number of Currently Logged in Users	UsersSummary	LogedInUsersCount		\N	\N	number	Data
...
MonAgentNumberOfInboundCallsOnly	Agent - Number of Incoming External Calls	User	InteractionsCount	 (InteractionType=="Call" ||  InteractionType=="Callback") && CallType=="External" && Direction=="Incoming"	\N	\N	number	Agent
...
MonAgentAverageMakeCallDuration	Agent - Average Outbound Call Duration	User	TotalStatusDurationAvg	Out Ext Call	\N	\N	time	Agent
MonAgentState	Agent - Current Status	User	CurStatusTitle		\N	\N	text	Agent
MonAgentActiveInteractionId	Agent - Active Interaction ID	User	LongestInteractionId	 	\N	\N	text	Agent
QueueNumAnsweredCallbacks60sec	QM - Number of Answered Callbacks in 60 sec	Interactions Summary	InteractionsCount	(InteractionType=="Callback") && (CallType=="External")  && Direction == "Incoming" && IsAnswered  && TimeInQueue<60	\N	\N	number	Data
MonAgentTodayLogin	Agent - ID of a representative who was connected today	User	IsTodayLogin		\N	\N	text	Agent
QueueNumIncomingCompletedCalls	QM - Number of Incoming Calls excluding Waiting	Interactions Summary	InteractionsCount	(InteractionType=="Call") && (CallType=="External")  && Direction == "Incoming" && !IsInQueue && !IsCallbackRequest	\N	\N	number	Data
QueueNumIncomingCompletedCallbacks	QM - Number of Incoming Callbacks excluding Waiting	Interactions Summary	InteractionsCount	(InteractionType=="Callback") && (CallType=="External")  && Direction == "Incoming" && !IsInQueue && !IsCallbackRequest	\N	\N	number	Data
QueueNumIncomingCompletedCallsAndCallbacks	QM - Number of Incoming Calls and Callbacks excluding Waiting	Interactions Summary	InteractionsCount	(InteractionType=="Call" || InteractionType=="Callback") && (CallType=="External")  && Direction == "Incoming" && !IsInQueue && !IsCallbackRequest	\N	\N	number	Data
QueueNumIncomingCompletedChats	QM - Number of Incoming Chats excluding Waiting	Interactions Summary	InteractionsCount	(InteractionType=="Chat") && (CallType=="External")  && Direction == "Incoming" && !IsInQueue  && !IsCallbackRequest	\N	\N	number	Data
QueueNumIncomingCompletedInteractions	QM - Number of Incoming Interactions excluding Waiting	Interactions Summary	InteractionsCount	(CallType=="External")  && Direction == "Incoming" && !IsInQueue  && !IsCallbackRequest && (InteractionType=="Chat" || InteractionType=="email")	\N	\N	number	Data
\.
