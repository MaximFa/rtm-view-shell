-- Migration: 20260613_014_schema_reconcile
-- Purpose: ONE-PASS holistic schema reconcile — all missing UNIQUE constraints + indexes + columns
-- ROOT CAUSE: Clean rebuild = EF migrate + db/functions/; does NOT apply schema.sql -> structural drift
-- This migration = full-coverage durable patch for the 42883/42703/23505/42P10 class
-- ADDITIVE ONLY — no drops; guarded for idempotency; safe to apply on any server
--
...
VALUES ('20260613_014_schema_reconcile')
