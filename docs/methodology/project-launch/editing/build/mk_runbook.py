import os
g=open("gen.js",encoding="utf-8").read()
head=g.split("const body = [];")[0] + "const body = [];\n"
head=head.replace("const METRICS = require('/tmp/build/metrics_rows.js');\n","")
...
open("gen_runbook.js","w",encoding="utf-8").write(head + COVER + BODY + DOC)
print("gen_runbook.js written")
