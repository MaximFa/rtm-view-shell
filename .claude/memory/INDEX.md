...
- [terminology](terminology.md) — Pablo's shorthand: СС = Claude Code, Shell = CcDashboard.Web (2026-06-08)
- [deploy-shell-connstring-grabli](deploy-shell-connstring-grabli.md) — RTMViewShell 28P01: install не вписывает Shell prod conn-string; pw в appsettings.Development.json (2026-07-02)
