...
## Broken Calc metric references — 2026-06-05 (pending fix)

Two Calc metrics have broken `[MetricId]` references because the actual MetricIds have a typo ("ef" instead of "ed"):

| Metric | Broken reference | Actual MetricId |
|---|---|---|
| `QueuePctAbandonedCallsTotal` | `[QueueNumAbandonedCalls]` | `QueueNumAbandonefCalls` |
| `QueuePctAbandonedCallbacksTotal` | `[QueueNumAbandonedCallbacks]` | `QueueNumAbandonefCallbacks` |

**Symptom:** Both metrics always return 0.0% — numerator resolves to 0 because the referenced MetricId doesn't exist.

**Fix:** Add alias metrics with correct spelling (no typo):
```sql
INSERT INTO "RTSGrid_Metric" ("MetricId", "Description", "DataType", "MetricFunction", "MetricParameter", "MetricFormat", "DefaultValue", "ValueType", "MetricType")
VALUES
    ('QueueNumAbandonedCalls', 'QM - Number of Abandoned Calls (alias)', 'Interactions Summary', 'InteractionsCount',
     '(InteractionType=="Call") && (CallType=="External") && Direction == "Incoming" && IsAbandoned && !IsCallbackRequest', NULL, NULL, 'number', 'Data'),
    ('QueueNumAbandonedCallbacks', 'QM - Number of Abandoned Callbacks (alias)', 'Interactions Summary', 'InteractionsCount',
     '(InteractionType=="Callback") && (CallType=="External") && Direction == "Incoming" && IsAbandoned && !IsCallbackRequest', NULL, NULL, 'number', 'Data')
ON CONFLICT ("MetricId") DO NOTHING;
```
Then run `Export-All.ps1` and push.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
