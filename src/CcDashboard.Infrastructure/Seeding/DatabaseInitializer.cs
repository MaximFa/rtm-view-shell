    ...
    ILogger<DatabaseInitializer> logger) : IDatabaseInitializer
{
    ...
    private async Task SeedWidgetCatalogAsync(CancellationToken ct)
    {
        var items = new List<WidgetCatalogItem>
        {
            ...
            new() { Id = Uuid.NewSequential(), Category = "General metrics", Name = "WFM Forecast", Description = "Real-time workforce management metrics showing Erlang-based predictions for service level, staffing requirements, and queue performance.", IsActive = true },
        };
