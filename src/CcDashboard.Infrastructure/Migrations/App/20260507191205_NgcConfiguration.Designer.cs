...
namespace CcDashboard.Infrastructure.Migrations.App
{
    ...
    [Migration("20260507191205_NgcConfiguration")]
    partial class NgcConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CcDashboard.Domain.Domain.NgcBusinessUnitQueue", b =>
                {
                    b.Property<int>("BusinessUnitId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CcDashboard.Domain.Domain.NgcBusinessUnitQueue", b =>
                {
                    ...
                    b.HasOne("CcDashboard.Domain.Domain.NgcQueue", "Queue")
                        .WithMany()
            ...
            modelBuilder.Entity("CcDashboard.Domain.Domain.NgcSupergroupAgentGroup", b =>
                {
                    b.HasOne("CcDashboard.Domain.Domain.NgcAgentGroup", "AgentGroup")
                        .WithMany()
